...
@section('content')
    ...
    <form class="space-y-6" action="{{ route('log-in') }}" method="POST">
        ...
        {{-- Message Banner (login required) --}}
        @if(session('message'))
        <div class="flex items-center gap-3 px-4 py-3 rounded-lg bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-700 text-blue-800 dark:text-blue-300 text-sm">
