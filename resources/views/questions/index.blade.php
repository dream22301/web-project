        ...
        <form action="{{ route('questions.store') }}" method="POST" class="p-6 sm:p-8 space-y-5">
            ...
            <div>
                <label for="key_code" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                    Kode Unik (Key)
                    <span class="ml-1 text-xs font-normal text-gray-400 dark:text-gray-500">(kosongkan untuk generate otomatis)</span>
                </label>
    ...
    <div class="max-w-3xl" id="question-list">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
            <div class="flex items-center gap-3">
                <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Paket Soal Anda</h2>
                <span class="text-sm text-gray-400 dark:text-gray-500">Total {{ $questionSets->total() }}</span>
            </div>
        ...
        <div class="text-center py-12 bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700">
            ...
            <p class="text-sm text-gray-400 dark:text-gray-500">Belum ada paket soal. Buat paket pertama Anda di atas.</p>
        </div>
        @else
