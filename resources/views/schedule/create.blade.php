                                ...
                                <div class="mb-2">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="p-3 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700 opacity-70 hover:opacity-100 transition-opacity">
                                            ...
                                            <p class="text-xs text-gray-500 mt-1">Kelas {{ $item->class }} &bull; Jam {{ $item->start_time }}-{{ $item->end_time }}</p>
                                            <div class="mt-3 flex items-center justify-between">
                                                <span class="text-[10px] text-gray-400">{{ $item->updated_at->diffForHumans() }}</span>
                                                <a href="{{ route('schedule.edit', $item->id) }}" class="text-xs font-medium text-blue-600 dark:text-blue-400 hover:text-blue-500">Pulihkan / Edit</a>
                                            </div>
                                        </div>
                                        @endforeach
                                    </div>
