...
@section('content')
    ...
    <!-- Placeholder content -->
    <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg border border-gray-100 dark:border-gray-700 min-h-100 flex items-center justify-center transition-colors">
